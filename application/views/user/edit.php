      	...
      	<div class="box box-info">
			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						<label for="user_rating" class="control-label">Ratings</label>
						<div class="form-group">
							<input type="text" name="user_rating" value="<?php echo ($this->input->post('user_rating') ? $this->input->post('user_rating') : $user['user_rating']); ?>" class="form-control" id="user_rating" />
						</div>
					</div>
					<div class="col-md-6">
